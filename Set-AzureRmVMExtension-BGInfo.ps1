...
#>
Set-AzureRmVMExtension -ExtensionName BGInfo -Publisher Microsoft.Compute -Version 2.1 -ExtensionType BGInfo -Location westus -ResourceGroupName YOUR_RESOURCE_GROUP -VMName YOUR_VM_NAME